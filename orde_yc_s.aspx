	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_seekStr() {///  搜尋按下時，執行
                ...
                var t_where = " 1=1 " + q_sqlPara2("odate", t_bdate, t_edate) + q_sqlPara2("noa", t_noa) + q_sqlPara2("comp", t_comp) + q_sqlPara2("salesno", t_salesno) + q_sqlPara2("custno", t_custno) + q_sqlPara2("stype", t_stype) + q_sqlPara2("contract", t_contract)+ q_sqlPara2("worker", t_worker);
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a id='lblWorker'>製單</a></td>
