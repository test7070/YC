	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_seekStr() {///  搜尋按下時，執行
                ...
                var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("cno", t_cno) 
                + q_sqlPara2("datea", t_bdate, t_edate) + q_sqlPara2("mon", t_mon) + q_sqlPara2("tggno", t_tggno) 
                + q_sqlPara2("invono", t_invono) + q_sqlPara2("accno", t_accno)+ q_sqlPara2("payano", t_payno);
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td><a id='lblPayano'>預付單號 </a></td>
					<td><input class="txt" id="txtPayano" type="text" style="width:215px; font-size:medium;" /></td>
				</tr>
				<tr class='seek_tr'>
