...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			var bbmNum = [['txtPrice', 7, 3, 0],['txtTotal', 10, 0, 1], ['txtMoney', 10, 0, 1], ['txtTax', 10, 0, 1]];
			var bbsNum = [];
			var bbmMask = [];
			var bbsMask = [];
			q_sqlCount = 6;
			...
			aPop = new Array(
				...
				['txtCustno', 'lblCust', 'cust', 'noa,nick,paytype,trantype,tel,fax,zip_fact,addr_fact,salesno,sales,price', 'txtCustno,txtComp,txtPaytype,cmbTrantype,txtTel,txtFax,txtPost,txtAddr,txtSalesno,txtSales,txtPrice', 'cust_b.aspx'],
			...
			function _btnSeek() {
				if (q_cur > 0 && q_cur < 4)
					return;
				q_box('orde_yc_s.aspx', q_name + '_s', "500px", "450px", q_getMsg("popSeek"));
			}
